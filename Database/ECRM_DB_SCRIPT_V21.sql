...
CREATE TABLE `tblsystemconfiguration` (
  `ConfigKey` varchar(50) CHARACTER SET utf8 NOT NULL,
...
INSERT INTO `tblsystemconfiguration` VALUES ('CHAIRHIGH','3','Ghế độ ưu tiên cao'),('CHAIRLOW','1','Ghế độ ưu tiên thấp'),('SERIOUSLYDAMGED','50','Hư hại tối đa'),('TABLEHIGH','5','Bàn độ ưu tiên cao'),('TABLELOW','2','Bàn độ ưu tiên thấp'),('USERHIGH_PRIORITYHIGH','50','Độ ưu tiên cao, không sử dụng được'),('USERHIGH_PRIORITYLOW','15','Độ ưu tiên thấp không sử dụng được'),('USERHIGH_PRIORITYMEDIUM','30','Độ ưu tiên trung bình, không sử dụng được'),('USERLOW_PRIORITYHIGH','20','Độ ưu tiên cao, sử dụng được'),('USERLOW_PRIORITYLOW','10','Độ ưu tiên thấp, sử dụng được'),('USERLOW_PRIORITYMEDIUM','10','Độ ưu tiên trung bình, sử dụng được');
...
-- Dump completed on 2015-08-19 10:42:49
