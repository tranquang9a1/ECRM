                                            ...
                                            <div class="row">
                                                ...
                                                <div class="width-25">
                                                    <div class="group-button">
                                                        <div title="Xem"
                                                             onclick="showReportDetail(${newReport[i].roomId})"
                                                             class="btn btn-detail btn-text">Xem
                                                        </div>
                                                        <div title="Khắc phục tất cả"
                                                             onclick="conform(2, ${newReport[i].roomId})"
                                                             class="btn btn-orange btn-text">Khắc phục
                                                        </div>
                                                    </div>
                                                </div>
                                                <p class="clear"></p>
                                ...
                                <div class="body-table">
                                    <c:forEach items="${finishReport}" var="item">
                                        <div class="row">
                                            ...
                                            <div class="width-15">
                                                <div class="group-button">
                                                    <div title="Xem" style="line-height: 12px;"
                                                         onclick="showFinishReport(${item.reportId})"
                                                         class="btn btn-detail">Xem
                                                    </div>
                                                </div>
                                            </div>
                                            <p class="clear"></p>
