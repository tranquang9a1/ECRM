    ...
    <c:otherwise>
        ...
        <div class="container">
            <div class="title page-title right-button">
                ...
                <div><input type="button" class="btn btn-orange" onclick="showModal(1,'CreateAccount');"
                            value="Tạo Tài Khoản"/>
                </div>
                <div class="clear"></div>
            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="row" style="background-color: hotpink">
                                    ...
                                    <div class="control">
                                        <c:choose>
                                            <c:when test="${u.status}">
                                                <input type="button" class="btn btn-orange" value="Deactivate"
                                                       onclick="Deactivate('${u.username}')"/>
                                            </c:when>
                                            <c:otherwise>
                                                <input type="button" class="btn btn-orange" value="Activate"
